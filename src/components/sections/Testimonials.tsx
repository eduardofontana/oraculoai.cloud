      ...
      <div className="container-main">
        ...
        <div className="max-w-3xl mx-auto">
            ...
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                <div className="text-center px-4">
                  ...
                  <p className="font-bold text-[#0A2540]">{item.name}</p>
          ...
          <div className="flex items-center justify-center gap-4 mt-8">
            <button
              onClick={prev}
              className="w-12 h-12 rounded-full border border-gray-200 flex items-center justify-center hover:bg-purple-50 hover:border-purple-200 hover:text-[#7B4DFF] transition-colors"
              aria-label="Anterior"
            >
